		...
		<table border="0" cellpadding="5" cellspacing="1">
			...
			?>
				<tr>
					...
					<td class="list_td<?php print $i ?>"><a href="javascript:form.act.value='fManager';form.sName.value='<?php print $article ?>';form.sRoom.value='<?php print $room ?>';form.sumbit();">表示</a></td>
